ingester aws_elb_cloudstream module {
  ...
  gauge "latency_avg" {
    ...
    source prometheus "lcu" {
      query = "sum by (LoadBalancerName) (amazonaws_com_AWS_ELB_Latency_sum{LoadBalancerName='$input{LoadBalancerName}'}) / sum by (LoadBalancerName) (amazonaws_com_AWS_ELB_Latency_sum{LoadBalancerName='$input{LoadBalancerName}'})"
...
ingester aws_elb_internal_cloudstream module {
  frequency  = 60
  lookback   = 600
  timeout    = 30
  resolution = 60
...
ingester aws_elb_internal_endpoint_cloudstream module {
  frequency  = 60
  lookback   = 600
  timeout    = 30
  resolution = 60
