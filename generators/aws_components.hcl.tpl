extends aws_alb_cloudwatch "albs_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_alb_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_elb_cloudwatch "elbs_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_elb_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_elasticache_redis_cloudwatch "elasticache_redis_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_elasticache_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_dynamodb_table_operation_cloudwatch "dynamodb_table_ops_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_dynamodb_cloudwatch.hcl"
  vars = {
    using = "<region>"
...
extends aws_rds_logical_cloudwatch "rds_tables_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_rds_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_dax_cloudwatch "dax_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_dax_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_lambda_cloudwatch "lambda_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_lambda_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_ec2_cloudwatch "ec2_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_ec2_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_apigateway_cloudwatch "apigateway_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_apigateway_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_elasticsearch_cloudwatch "elasticsearch_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_elasticsearch_cloudwatch.hcl"
  vars = {
    using  = "<region>"
...
extends aws_sqs_cloudwatch "sqs_<region>" {
  source_uri = "https://github.com/last9/iox-registry/releases/download/v0.0.8/aws_sqs_cloudwatch.hcl"
  vars = {
    using  = "<region>"
